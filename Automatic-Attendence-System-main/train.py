...
class Train:
    def __init__(self,root):
        ...
        img_top=Image.open(r"Images\trainingData.png")
...
# Buttonn
        b1_1=Button(self.root,text="TRAIN DATA",command=self.train_classifier ,cursor="hand2",font=("helvetica", 30,"bold"),bg="red",fg="white")
        b1_1.place(x=0,y=380,width=1530,height=60)

        img_bottom=Image.open(r"Images\mlearning.jpg")
