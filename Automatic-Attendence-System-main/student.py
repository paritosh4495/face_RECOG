...
# img bg
        ...
        radionbtn1=ttk.Radiobutton(class_student_frame,command=self.generate_dataset,variable=self.var_radio1,text="take photo sample",value="Yes")
        ...
        take_photo_btn=Button(btn_frame1,command=self.generate_dataset,text="Take a photo Sample",width=34,font=("times new roman",13,"bold"),bg="blue",fg="white")
    ...
    def generate_dataset(self):
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.var_std_id.get=="":
            ...
            try:
                ...
                # ======== Load predifined data on facefrontal from cv2 =============
                ...
                messagebox.showinfo("Resut",'Generating data set completed!!!')
            except Exception as es:
                messagebox.showerror("Error",f"Due to:{str(es)}", parent=self.root)
